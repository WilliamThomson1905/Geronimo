...
namespace GeronimoHBS.Controllers
{
    public class VenuesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "VenueID,VenueName,VenueDescription,VenueCapacity,RateForDay,EventOverviewID")] Venue venue)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VenueID,VenueName,VenueDescription,VenueCapacity,RateForDay,EventOverviewID")] Venue venue)
        {
            if (ModelState.IsValid)
            {
